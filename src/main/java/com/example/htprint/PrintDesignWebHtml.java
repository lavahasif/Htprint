...
//    }
//
//    public String printtdWLeft(String data) {
//        return "<td style=\"text-align:left;\">" + data + "</td>";
//    }
//
//    int IMAGE1_0 = 0;
//    int IMAGE2_1 = 1;
...
//    }
//
//    public String printtable2(String data) {
//        return "<table >" + data + "</table>";
//    }
//
...
//    }
//
//    public String HeadColumndataWebHeaddesc(String[] heads) {
//
//        if (PrinterHead._4Head.name == heads.length) {
//            return printtr(printtd(heads[0]) + printtdWRight(heads[1]) + printtdWRight(heads[2]) + printtdWRight(heads[3]));
//        } else if (PrinterHead._3Head.name == heads.length) {
//        } else if (PrinterHead._2Head.name == heads.length) {
//            return printtr(printtd(heads[0]) + printtdWLeft(heads[1]));
//        } else {
//        }
//
//        return "";
